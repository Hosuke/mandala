...
const UI_ZH = {
  ...
  // 觸屏無滾輪、無鍵盤，另立其語
  hintAerialTouch: '拖曳旋觀 · 雙指遠近 · 點尊得詳',
  guideHead: '法具之用', guideClose: '了知',
  guideNote: '懸停諸鈕，可再見其義', guideNoteTouch: '長按諸鈕，可再見其義',
  hintFPTouch: '拖曳環顧 · 點「出壇」還觀',
  hintKanTouch: '輕觸以進 · 觀無促令',
  realms: ['大悲胎藏', '不　二', '金剛界'],
...
const UI_EN = {
  ...
  hintAerialTouch: 'Drag to orbit · Pinch to zoom · Tap a deity',
  guideHead: 'The instruments', guideClose: 'Understood',
  guideNote: 'Hover any button to see this again', guideNoteTouch: 'Long-press any button to see this again',
  hintFPTouch: 'Drag to look · Tap “Leave” to return',
  hintKanTouch: 'Tap to proceed · No haste in contemplation',
  ...
  titles: {
    ...
    genten: 'Genten: projections of the historical silk paintings (CC0, public domain)',
...
const UI_JA = {
  ...
  hintAerialTouch: 'ドラッグで旋観 · ピンチで遠近 · 尊に触れて詳らかに',
  guideHead: '法具の用', guideClose: '了知',
  guideNote: '鈕に指を置けば再び見られる', guideNoteTouch: '鈕を長押しすれば再び見られる',
  hintFPTouch: 'ドラッグで環顧 · 「出壇」で戻る',
  hintKanTouch: '軽く触れて進む · 観に促しなし',
